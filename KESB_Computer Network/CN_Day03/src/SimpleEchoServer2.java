...
public class SimpleEchoServer2 implements Runnable {
    // 다중 접속 에코 서버
    private static Socket clientSocket;
    public SimpleEchoServer2(Socket clientSocket)
    {
    ...
    public static void main(String[] args) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(20000)) {
            while (true) {
                ...
                SimpleEchoServer2 tes = new SimpleEchoServer2(clientSocket);
                eService.submit(tes);
            }
